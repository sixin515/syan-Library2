...
const hadCodeUsername = "user"
const hadCodepassword = "123456"
...
const submitForm = () => {
  ...
  && formData.value.password === hadCodepassword 
  && formData.value.username === hadCodeUsername )
  {
    alert("login success")
...
// Uncomment this function if you intend to use it
const clearForm = () => {
  formData.value = {
    username: '',
    password: '',
